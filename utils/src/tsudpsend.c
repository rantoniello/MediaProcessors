...
static long long int usecDiff(struct timespec* time_stop, struct timespec* time_start) //RAL
{
...
int tsudpsend(int argc, char *argv[], volatile int *exit_flag) //RAL
{
    int sockfd;
    int len;
    int sent;
